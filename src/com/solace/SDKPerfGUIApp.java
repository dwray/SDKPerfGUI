...
//					    UIManager.setLookAndFeel("com.seaglasslookandfeel.SeaGlassLookAndFeel");
					...
					window.frmSdkperfGui.setMinimumSize(new Dimension(680,335));
	...
	private void initialize() {
		...
		frmSdkperfGui.getContentPane().setLayout(new MigLayout("insets 4px", "[115.00px][112.00px][294.00px,grow]", "[159.00px][16px][54.00px,grow][25.00,grow]"));
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		frmSdkperfGui.getContentPane().add(tabbedPane, "cell 0 0 3 1");
		
		JPanel Clients = new JPanel();
		tabbedPane.addTab("sdkPerf", null, Clients, null);
		Clients.setLayout(new MigLayout("insets 0", "[173px][305.00]", "[16px][][][]"));
		
		//SDKPerfControls
		tabbedPanePublishers = new JTabbedPane(JTabbedPane.TOP);
		frmSdkperfGui.getContentPane().add(tabbedPanePublishers, "cell 0 2 3 1,grow");
				
		tabbedPaneSubscribers = new JTabbedPane(JTabbedPane.TOP);
		frmSdkperfGui.getContentPane().add(tabbedPaneSubscribers, "cell 0 3 3 1,grow");
		...
		panelAdvancedPublisher.setLayout(new MigLayout("insets 0", "[][133.00][][23.00][grow][grow]", "[][][][][]"));
		...
		panelAdvancedSubscriber.setLayout(new MigLayout("insets 0", "[][166.00][grow]", "[][][]"));
		...
		panelTimed.setLayout(new MigLayout("insets 0", "[grow]", "[][][][]"));
		...
		panelLatency.setLayout(new MigLayout("insets 0", "[][][grow][grow]", "[][][]"));
		...
		tglbtnHideOutput.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (tglbtnHideOutput.getSelectedObjects() == null) {
					...
					frmSdkperfGui.setSize(defaultSize);
//					frmSdkperfGui.pack();
				} else {
					// hide output
